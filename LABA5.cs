...
namespace LABA5
{
    class RPN
    {
        ...
        static private string GetExpression(string input)
        {
            ...
            Console.WriteLine("Выражение в постфиксной записи:");
    ...
    class Program
    {
        ...
        {
            Console.Write("Введите выражение:  (  Подсказка для ввода 3,1-(5,4+0,2*9,6)/7,8  ) Ответ = 2,16"); //Предлагаем ввести выражение
